...
// ** Tab Content Imports
import DialogTabDetails from '@/components/dialog-examples/create-app-tabs/DialogTabDetails'
import DialogTabBilling from '@/components/dialog-examples/create-app-tabs/DialogTabBilling'
import DialogTabDatabase from '@/components/dialog-examples/create-app-tabs/DialogTabDatabase'
import DialogTabFramework from '@/components/dialog-examples/create-app-tabs/DialogTabFramework'
